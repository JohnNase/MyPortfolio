    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://github.com/JohnNase/water-filter-system" target="_blank" rel="noreferrer"><img src={mock04} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/JohnNase/water-filter-system" target="_blank" rel="noreferrer"><h2>Water Filter System with React</h2></a>
            ...
            <div className="project">
                <a href="https://github.com/JohnNase/Facial-Emotion-Recognition-System" target="_blank" rel="noreferrer"><img src={mock03} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/JohnNase/Facial-Emotion-Recognition-System" target="_blank" rel="noreferrer"><h2>Facial Emotion Recognition System </h2></a>
            ...
            <div className="project">
                <a href="https://github.com/JohnNase/JavaFX-Bookstore-APP" target="_blank" rel="noreferrer"><img src={mock01} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/JohnNase/JavaFX-Bookstore-APP" target="_blank" rel="noreferrer"><h2>Java Bookstore App</h2></a>
            ...
            <div className="project">
                <a href="https://github.com/JohnNase/Flight-Booking-System" target="_blank" rel="noreferrer"><img src={mock02} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/JohnNase/Flight-Booking-System" target="_blank" rel="noreferrer"><h2>Flight Booking Website</h2></a>
            ...
            <div className="project">
                <a href="https://github.com/JohnNase/E-Commerce-Retail-App" target="_blank" rel="noreferrer"><img src={mock06} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/JohnNase/E-Commerce-Retail-App" target="_blank" rel="noreferrer"><h2>React E-Commerce Retail Website</h2></a>
            ...
            <div className="project">
                <a href="https://github.com/JohnNase/Movie-Recommendation-system-" target="_blank" rel="noreferrer"><img src={mock05} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/JohnNase/Movie-Recommendation-system-" target="_blank" rel="noreferrer"><h2>Movie Recommendation System Using Flask</h2></a>
